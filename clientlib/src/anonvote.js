...
class AnonVote {
	...
	async newProcess(topic, censusIpfsHash, censusRoot, startBlock, endBlock, minMajority, minTurnout, signer) {
		if (!this.web3gw) {
			throw new Error("web3gw not defined. Use connect() first");
		}
